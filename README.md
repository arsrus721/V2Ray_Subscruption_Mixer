...
Готово — ниже **полностью готовый GitHub README**, на **английском**, аккуратно оформленный, со всеми таблицами и со **ссылкой на подробное описание headers** для V2RayTun.
